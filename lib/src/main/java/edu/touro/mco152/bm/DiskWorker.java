...
public class DiskWorker {
    ...
    public final SwingUIWorker<Boolean> currentWorker;

    public DiskWorker(String workerType) {
        ...
        currentWorker = switch (workerType) {
            case "SwingUIWorker" -> new SwingUIWorker<>(backgroundTask);
            case "CmdLineUIWorker" -> new SwingUIWorker<>(backgroundTask);
            case "WebUIWorker" -> new SwingUIWorker<>(backgroundTask);
            case "proceduralUIWorker" -> new SwingUIWorker<>(backgroundTask);

            default -> throw new IllegalStateException("Illegal Worker Type Passed");
        };
        ;
    }
    ...
    protected Boolean doInBackground() throws Exception {
         ...
         */
             ...
             */
                for (int m = startFileNum; m < startFileNum + App.numOfMarks && !currentWorker.getIsCancelled(); m++) {
                    ...
                    try {
                        try (RandomAccessFile rAccFile = new RandomAccessFile(testFile, mode)) {
                             ...
                             */
                                currentWorker.setTheProgress((int) percentComplete);
                            }
                        }
                 ...
                 */
                    currentWorker.publishChunks(wMark);
         ...
         */
            ...
            if (App.readTest && App.writeTest && !currentWorker.getIsCancelled()) {
            ...
            if (App.readTest) {
                ...
                for (int m = startFileNum; m < startFileNum + App.numOfMarks && !currentWorker.getIsCancelled(); m++) {
                    ...
                    currentWorker.publishChunks(rMark);
    ...
    protected void done() {
        ...
        try {
            lastStatus = currentWorker.getResult();   // record for future access
        } catch (Exception e) {
